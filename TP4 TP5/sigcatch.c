...
/* QUESTION 2 */
/*
les lignes 9 à 11 sont du design de grand-père
signa_itoi (text) renvoie un text associé au numéro
ligne 24 à 29 : attache la fonction callback (gestionnaire callback) de 1 à 22 (différent sur Mac)
ligne 26 à 27 : affiche un message d'erreur pour les signaux qui ne sont pas rattrapables/attachables/à comportement redéfinissable,
c'est-à-dire les signaux dont on ne peut pas modifier le comportement par défaut
ligne 33 à 36 : boucle infinie (car quand on tombe sur z, on reboucle) : affichage d'un caractère puis attendre d'un signal
pause = attendre le retour d'un certain signal
ligne 15 à 16 : affiche le signal rattrapé (reçu) avec son numéro
*/